...
var AsyncSelect = /** @class */ (function (_super) {
    ...
    AsyncSelect.prototype.render = function () {
        ...
        return (React.createElement(ReactAsyncSelect, { classNamePrefix: "gf-form-select-box", className: selectClassNames, components: {
            ...
            }, defaultValue: defaultValue, value: value, getOptionLabel: getOptionLabel, getOptionValue: getOptionValue, menuShouldScrollIntoView: false, onChange: onChange, loadOptions: loadOptions, isLoading: isLoading, defaultOptions: defaultOptions, placeholder: placeholder || 'Choose', styles: resetSelectStyles(), loadingMessage: loadingMessage, noOptionsMessage: noOptionsMessage, isDisabled: isDisabled, isSearchable: isSearchable, isClearable: isClearable, autoFocus: autoFocus, onBlur: onBlur, openMenuOnFocus: openMenuOnFocus, maxMenuHeight: maxMenuHeight, isMulti: isMulti, backspaceRemovesValue: backspaceRemovesValue }));
    };
