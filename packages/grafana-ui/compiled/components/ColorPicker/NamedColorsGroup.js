...
export var ColorSwatch = function (_a) {
    var color = _a.color, label = _a.label, _b = _a.variant, variant = _b === void 0 ? ColorSwatchVariant.Small : _b, isSelected = _a.isSelected, theme = _a.theme, otherProps = tslib_1.__rest(_a, ["color", "label", "variant", "isSelected", "theme"]);
    ...
    return (React.createElement("div", tslib_1.__assign({ style: {
            display: 'flex',
            alignItems: 'center',
            cursor: 'pointer',
        } }, otherProps),
...
var NamedColorsGroup = function (_a) {
    var colors = _a.colors, selectedColor = _a.selectedColor, onColorSelect = _a.onColorSelect, theme = _a.theme, otherProps = tslib_1.__rest(_a, ["colors", "selectedColor", "onColorSelect", "theme"]);
    var primaryColor = find(colors, function (color) { return !!color.isPrimary; });
    return (React.createElement("div", tslib_1.__assign({}, otherProps, { style: { display: 'flex', flexDirection: 'column' } }),
