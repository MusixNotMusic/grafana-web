...
var SpectrumPalettePointer = function (_a) {
    ...
    if (direction === 'vertical') {
        pointerStyles = tslib_1.__assign({}, pointerStyles, { left: 'auto' });
        topArrowStyles = {
    ...
    return (React.createElement("div", { style: styles.picker },
        React.createElement("div", { style: tslib_1.__assign({}, pointerStyles, topArrowStyles) }),
        React.createElement("div", { style: tslib_1.__assign({}, pointerStyles, bottomArrowStyles) })));
};
